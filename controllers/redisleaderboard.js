...
// Function to fetch and show the leaderboard
...
//       } else {
//         // Convert the retrieved data into an array of arrays [username, totalAmount]
//         const leaderboardData = []
//         for (let i = 0; i < leaderboard.length; i += 2) {
//           leaderboardData.push([leaderboard[i], leaderboard[i + 1]])
//         }
...
// exports.showLeaderboard = async (req, res, next) => {
//   try {
//     // Fetch the leaderboard data from Redis as a sorted set with scores
//     client.zrangeWithScores('leaderboard', 0, -1, (err, leaderboard) => {
//       if (err) {
//         console.error('An error occurred while fetching leaderboard data:', err)
//         res.status(500).json({ error: 'An error occurred while fetching leaderboard data' })
//       } else {
...
//           leaderboardData.push([leaderboard[i].value, leaderboard[i].score])
//         }
